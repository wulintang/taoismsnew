module.exports = {
    ...
    head: [
        ...
        ['script', { src: 'https://cdn.wulintang.cn/daohang/html/js/jquery.cookie.js' }],
        ['script', { src: 'https://cdn.wulintang.cn/daohang/html/js/jquery.fixed.js' }],
        ['script', { src: 'https://cdn.wulintang.cn/daohang/html/js/init.fixed.js' }],
        ['link', {rel: 'manifest', href: `/manifest.json`}],
        ['link', { rel: 'stylesheet', type: 'text/css', href: 'https://cdn.wulintang.cn/ziti/font.css' }],
        ['link', { rel: 'stylesheet', type: 'text/css', href: 'https://cdn.wulintang.cn/ziti/icon/chndao.css' }],
        ['link', { rel: 'stylesheet', type: 'text/css', href: 'https://cdn.wulintang.cn/daohang/html/css/fixed.css' }],
    ],
