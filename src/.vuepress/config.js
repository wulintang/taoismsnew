module.exports = {
    ...
    head: [
        ...
        ['script', { src: 'https://cdn.jsdelivr.net/gh/wulintang/cdn/daohang/html/js/jquery.cookie.js' }],
        ['script', { src: 'https://cdn.jsdelivr.net/gh/wulintang/cdn/daohang/html/js/jquery.fixed.js' }],
        ['script', { src: 'https://cdn.jsdelivr.net/gh/wulintang/cdn/daohang/html/js/init.fixed.js' }],
        ['link', {rel: 'manifest', href: `/manifest.json`}],
        ['link', { rel: 'stylesheet', type: 'text/css', href: 'https://cdn.jsdelivr.net/gh/wulintang/cdn/ziti/font.css' }],
        ['link', { rel: 'stylesheet', type: 'text/css', href: 'https://cdn.jsdelivr.net/gh/wulintang/cdn/ziti/icon/chndao.css' }],
        ['link', { rel: 'stylesheet', type: 'text/css', href: 'https://cdn.jsdelivr.net/gh/wulintang/cdn/daohang/html/css/fixed.css' }],
    ],
